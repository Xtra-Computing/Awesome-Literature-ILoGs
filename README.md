...
- [1. Class Imbalance](https://github.com/Xtra-Computing/ILoGs#1-class-imbalance)
  - [1.1 Node-Level Class Imbalance](https://github.com/Xtra-Computing/ILoGs#11-node-level-class-imbalance)
    - [1.1.1 Imbalanced Node CLassification](https://github.com/Xtra-Computing/ILoGs#111-imbalanced-node-classification)
    - [1.1.2 Node-Level Anomaly Detection](https://github.com/Xtra-Computing/ILoGs#112-node-level-anomaly-detection)
    - [1.1.3 Few-Shot Node Classification](https://github.com/Xtra-Computing/ILoGs#113-few-shot-node-classification)
    - [1.1.4 Zero-Shot Node Classification](https://github.com/Xtra-Computing/ILoGs#114-zero-shot-node-classification)
  - [1.2 Edge-Level Class Imbalance](https://github.com/Xtra-Computing/ILoGs#12-edge-level-class-imbalance)
    - [1.2.1 Few-Shot Link Prediction](https://github.com/Xtra-Computing/ILoGs#121-few-shot-link-prediction)
    - [1.2.2 Edge-Level Anomaly Detection](https://github.com/Xtra-Computing/ILoGs#122-edge-level-anomaly-detection)
  - [1.3 Graph-Level Class Imbalance](https://github.com/Xtra-Computing/ILoGs#13-graph-level-class-imbalance)
    - [1.3.1 Imbalanced Graph Classification](https://github.com/Xtra-Computing/ILoGs#131-imbalanced-graph-classification)
    ...
    - [1.3.3 Few-Shot Graph Classification](https://github.com/Xtra-Computing/ILoGs#133-few-shot-graph-classification)
- [2. Structure Imbalance](https://github.com/Xtra-Computing/ILoGs#2-structure-imbalance)
  - [2.1 Node-Level Structure Imbalance](https://github.com/Xtra-Computing/ILoGs#21-node-level-structure-imbalance)
    - [2.1.1 Imbalanced Node Degrees](https://github.com/Xtra-Computing/ILoGs#211-imbalanced-node-degrees)
    - [2.1.2 Node Topology Imbalance](https://github.com/Xtra-Computing/ILoGs#212-node-topology-imbalance)
    - [2.1.3 Long-Tail Entity Embedding on KGs](https://github.com/Xtra-Computing/ILoGs#213-long-tail-entity-embedding-on-kgs)
  - [2.2 Edge-Level Structure Imbalance](https://github.com/Xtra-Computing/ILoGs#22-edge-level-structure-imbalance)
    - [2.2.1 Few-Shot Relation Classification](https://github.com/Xtra-Computing/ILoGs#221-few-shot-relation-classification)
    - [2.2.2 Zero-Shot Relation Classification](https://github.com/Xtra-Computing/ILoGs#222-zero-shot-relation-classification)
    - [2.2.3 Few-Shot Reasoning on KGs](https://github.com/Xtra-Computing/ILoGs#223-few-shot-reasoning-on-kgs)
  - [2.3 Graph-Level Structure Imbalance](https://github.com/Xtra-Computing/ILoGs#23-graph-level-structure-imbalance)
    - [2.3.1 Imbalanced Graph Sizes](https://github.com/Xtra-Computing/ILoGs#231-imbalanced-graph-sizes)
    - [2.3.2 Imbalanced Topology Groups](https://github.com/Xtra-Computing/ILoGs#232-imbalanced-topology-groups)

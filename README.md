...
- [1. Class Imbalance](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#1-class-imbalance)
  - [1.1 Node-Level Class Imbalance](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#11-node-level-class-imbalance)
    - [1.1.1 Imbalanced Node CLassification](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#111-imbalanced-node-classification)
    - [1.1.2 Node-Level Anomaly Detection](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#112-node-level-anomaly-detection)
    - [1.1.3 Few-Shot Node Classification](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#113-few-shot-node-classification)
    - [1.1.4 Zero-Shot Node Classification](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#114-zero-shot-node-classification)
  - [1.2 Edge-Level Class Imbalance](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#12-edge-level-class-imbalance)
    - [1.2.1 Few-Shot Link Prediction](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#121-few-shot-link-prediction)
    - [1.2.2 Edge-Level Anomaly Detection](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#122-edge-level-anomaly-detection)
  - [1.3 Graph-Level Class Imbalance](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#13-graph-level-class-imbalance)
    - [1.3.1 Imbalanced Graph Classification](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#131-imbalanced-graph-classification)
    - [1.3.2 Graph-Level Anomaly Detection](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#132-graph-level-anomaly-detection)
    - [1.3.3 Few-Shot Graph Classification](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#133-few-shot-graph-classification)
- [2. Structure Imbalance](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#2-structure-imbalance)
  - [2.1 Node-Level Structure Imbalance](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#21-node-level-structure-imbalance)
    - [2.1.1 Imbalanced Node Degrees](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#211-imbalanced-node-degrees)
    - [2.1.2 Node Topology Imbalance](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#212-node-topology-imbalance)
    - [2.1.3 Long-Tail Entity Embedding on KGs](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#213-long-tail-entity-embedding-on-kgs)
  - [2.2 Edge-Level Structure Imbalance](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#22-edge-level-structure-imbalance)
    - [2.2.1 Few-Shot Relation Classification](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#221-few-shot-relation-classification)
    - [2.2.2 Zero-Shot Relation Classification](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#222-zero-shot-relation-classification)
    - [2.2.3 Few-Shot Reasoning on KGs](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#223-few-shot-reasoning-on-kgs)
  - [2.3 Graph-Level Structure Imbalance](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#23-graph-level-structure-imbalance)
    - [2.3.1 Imbalanced Graph Sizes](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#231-imbalanced-graph-sizes)
    - [2.3.2 Imbalanced Topology Groups](https://github.com/Xtra-Computing/Awesome-Literature-ILoGs/blob/main/README.md#232-imbalanced-topology-groups)
